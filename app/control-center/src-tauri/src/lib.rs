...
#[tauri::command]                                                                   
async fn write_to_pty(state: State<'_, PtyState>, data: String) -> Result<(),       
String> {                                                                           
...
#[tauri::command]                                                                   
async fn resize_pty(state: State<'_, PtyState>, rows: u16, cols: u16) -> Result<(), 
String> {                                                                           
...
pub fn run() {                                                                      
    tauri::Builder::default()                                                       
        ...
        .invoke_handler(tauri::generate_handler![spawn_shell, write_to_pty,         
resize_pty])                                                                        
